package com.example.cryptowell.presentation.coin_details.components
...
import com.example.cryptowell.presentation.coin_details.CoinDetailsviewModel
        ...
        state.coin?.let {coin->
            ...
            contentPadding = PaddingValues(20.dp)
               ...
               item {  Row(
                   ...
                   Text(text = "${coin.rank}. ${coin.coinName} (${coin.symbol}) ",
